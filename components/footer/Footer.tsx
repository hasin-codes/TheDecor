...
export const Footer: React.FC = () => {
  ...
  return (
    <footer className="relative w-full bg-[#050505] text-white pt-6 pb-4 overflow-hidden">
      ...
      <div className="w-full max-w-[1440px] mx-auto px-4 md:px-10 lg:px-14 mb-6">
        <div className="w-full bg-[#E31B23] rounded-2xl md:rounded-[2rem] p-6 md:p-10 flex flex-col items-start relative overflow-hidden">

          {/* Background Decor */}
          <div className="absolute inset-0 bg-[url('https://grainy-gradients.vercel.app/noise.svg')] opacity-20 mix-blend-overlay pointer-events-none"></div>
          <div className="absolute -top-[50%] -left-[20%] w-[150%] h-[150%] bg-gradient-to-b from-white/10 to-transparent rounded-full blur-3xl pointer-events-none"></div>
          ...
          <div className="relative z-10 w-full flex flex-col md:flex-row justify-between items-center gap-6 md:gap-10">
            ...
            <div className="flex flex-col sm:flex-row gap-3 w-full md:w-auto items-center">
              <a
                ...
                className="px-6 py-3 bg-white text-[#E31B23] rounded-full font-bold text-xs md:text-sm tracking-widest uppercase hover:bg-black hover:text-white transition-all duration-300 flex items-center justify-center gap-2 group whitespace-nowrap min-w-[140px]"
              >
                Hire Me
              ...
              <div className="flex gap-2">
                <a
                  href="mailto:hasin.innit@gmail.com"
                  className="w-10 h-10 md:w-12 md:h-12 bg-white/20 backdrop-blur-sm rounded-full flex items-center justify-center hover:bg-white hover:text-[#E31B23] transition-all duration-300"
                  title="Email"
                >
      ...
      <div className="w-full max-w-[1440px] mx-auto px-6 md:px-10 lg:px-14">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-4 pt-6">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-3">
              {[
                { icon: Facebook, href: "https://www.facebook.com/decorsdigital" },
                { icon: Instagram, href: "https://www.instagram.com/decorsdigital" },
                { icon: Twitter, href: "https://x.com/DecorsDigital" },
                { icon: Linkedin, href: "https://www.linkedin.com/company/decorsdigital" },
                { icon: Youtube, href: "https://www.youtube.com/@DecorsDigital" }
              ].map((Social, i) => (
                <a key={i} href={Social.href} target="_blank" rel="noopener noreferrer" className="w-8 h-8 flex items-center justify-center rounded-full border border-white/20 text-white/60 hover:text-brandRed hover:border-brandRed transition-all duration-300">
